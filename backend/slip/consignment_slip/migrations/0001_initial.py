# Generated by Django 4.2.3 on 2023-08-22 13:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='consignment_slip.consignment')),
            ],
            options={
