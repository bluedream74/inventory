# Generated by Django 4.2.3 on 2023-08-24 05:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='collection_slip.collection')),
            ],
            options={
