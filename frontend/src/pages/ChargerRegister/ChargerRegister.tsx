...
const ChargerRegister: React.FC = () => {
  const dispatch = useAppDispatch();
  const data = useAppSelector((state) => state.charger.chargerList);
  ...
  const [modalData, setModalData] = useState<ChargerInterface>({
    id: 0,
    name: "",
    code: "",
    phone: "",
  ...
  const DeleteModal = (
    <Dialog open={deleteOpen}>
      <DialogTitle textAlign="center">担当者削除</DialogTitle>
      <DialogContent>
        削除しましょか？
      </DialogContent>
      <DialogActions sx={{ p: '1.25rem' }}>
...
export default ChargerRegister;
