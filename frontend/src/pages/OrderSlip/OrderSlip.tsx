    ...
    <div className="order-slip">
      <div className="tool-bar">
        ...
        <div className="action-btn">
          <NonBorderRadiusButton variant="outlined">削除</NonBorderRadiusButton>
          <NonBorderRadiusButton variant="outlined">キャンセル</NonBorderRadiusButton>
          <NonBorderRadiusButton variant="outlined" >保存</NonBorderRadiusButton>
        </div>
      </div>
        ...
        <div className="common">
          <div className="common__left">
            <div className="common-item">
              <div className="common-item__small">
                ...
                <InputBase className='common-item__small__input-left' />
              </div>
            </div>
            <div className="common-item">
              <div className="common-item__small">
            ...
            <div className="common-item">
              ...
              <div className="common-item__small">
                ...
                <InputBase className='common-item__small__input-left' value={"100.0%"} />
              </div>
            </div>
            <div className="common-item">
          ...
          <div className="common__right">
            <div className="common-item">
              ...
              <div className="common-item__small">
                <FormControlLabel className='check-control' control={<Checkbox color="default" />} label="発注済み" />
              </div>
            </div>
            <div className="common-item">
              <div className="common-item__small">
              ...
              <div className="common-item__small">
                <FormControlLabel className='check-control' control={<Checkbox color="default" />} label="売上転送済み" />
              </div>
            </div>
            <div className="common-item">
              <div className="common-item__small">
              ...
              <div className="common-item__small">
                <FormControlLabel className='check-control' control={<Checkbox color="default" />} label="取置転送済み" />
              </div>
            </div>
          </div>
        </div>
